...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props){
        ...
        FargateService authService= createFargateService("AuthService", "auth-service",
                List.of(4005),
                authServiceDb,
                Map.of("JWT_SECRET","VGhpc0lzQVN1cGVyU3Ryb25nU2VjcmV0S2V5MTIzNDU2"));
    ...
    private Vpc createVpc(){
        return Vpc.Builder
                .create(this,"PatientManangementVPC")
                .vpcName("PatientManangementVPC")
                .maxAzs(2)
                .build();
    }
    ...
    private DatabaseInstance createDatabase(String id, String dbName){
        return DatabaseInstance.Builder
                .create(this,id)
                .engine(DatabaseInstanceEngine.postgres(PostgresInstanceEngineProps.builder().version(PostgresEngineVersion.VER_17_2).build()))
                .vpc(vpc)
    ...
    private FargateService createFargateService(String id, String imageName, List<Integer> ports, DatabaseInstance db, Map<String,String> additionalEnvVars){
        ...
        envVars.put("SPRING_KAFKA_BOOTSTRP_SERVERS","localhost.localstack.cloud:4510,localhost.localstack.cloud:4511,localhost.localstack.cloud:4512");
    ...
    private void createApiGatewayService(){
        ...
        FargateService apiGatewayService = FargateService.Builder.create(this, "APIGatewayService")
                .cluster(ecsCluster)
